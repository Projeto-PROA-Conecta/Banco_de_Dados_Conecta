...
select * from usuarios;
-- insert curriculos -- 
insert into Curriculo(formacao_academica,exeperiencia_profissional,certificacoes,habilidades,usuario_id)VALUES 
...
insert into Curriculo(formacao_academica,exeperiencia_profissional,certificacoes,habilidades,usuario_id)VALUES 
('Graduação em Exatas','6 anos como docente','MATLAB  Certified Associate - MathWorks','Capaz de manipular e gerenciar dados numéricos bem como realiza a modelagem de dados',3);
insert into Curriculo(formacao_academica,exeperiencia_profissional,certificacoes,habilidades,usuario_id)VALUES 
('Desenvolvedora Machine-Learning','9 anos de experiência com i.a','AWS Certified Machine Learning – Specialty','Ingles fluente,');
insert into Curriculo(formacao_academica,exeperiencia_profissional,certificacoes,habilidades,usuario_id)VALUES 
();
insert into Curriculo(formacao_academica,exeperiencia_profissional,certificacoes,habilidades,usuario_id)VALUES 
();