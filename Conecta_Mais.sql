...
insert into Empresas_cadastradas(empresa_id,nome,ramo,email,senha,endereco,matriz_ou_filial,cnpj) values 
(14,'Primora Ventures','Venture Capital e Investimentos em Tecnologia','Primora@gmail.com','25488','Rua Rebolo 9800','Filiais em outros locais com startups promissoras, como Berlim ou Shenzhen','47510515484987');
insert into Empresas_cadastradas(empresa_id,nome,ramo,email,senha,endereco,matriz_ou_filial,cnpj) values 
...
-- por favor amanhã organizar as vagas das empresas aqui em baixo verifique as vagas de acordo com as Empresas_cadastradas
insert into vagas(nome_vaga,descricao_vaga,categoria_vaga,endereco)value
 ('Desenvolvedor Full Stack', 'Desenvolvimento de aplicações web usando tecnologias modernas.', 'Tecnologia','Rua felis 78237'),
    ('Analista de Dados', 'Responsável pela análise e visualização de dados estratégicos.', 'Tecnologia','Rua calmes 7248'),
    ('Cientista de Pesquisa em Tecnologias Verdes', 'Planejamento e desenvolvimento de soluções de software voltadas á politicas verdes.', 'Tecnologia','Rua Francisco 8947'),
    ('Consultor de finanças voltadas ao ramo empresarial .', 'Consultor do ramo de negócios.', 'Consultor','Rua Jocalis 997'),
    ('Engenharia de Automação', 'Gestão de produção e automação.', 'Gestor','Rua Lima 505478'),
    ('Analista de Marketing', 'Estratégias e campanhas de marketing digital.', 'Marketing','Rua joyk 9897'),
    ('Vendedor Interno', 'Atendimento ao cliente e vendas internas.', 'Comercial','Rua Caibuiba 5689'),
    ('Atendente de Suporte', 'Suporte técnico ao cliente via telefone e chat.', 'Atendimento','Rua Neto 2658'),
    ('Desenvolvedor Mobile', 'Criação de aplicativos para plataformas iOS e Android.', 'Tecnologia','Rua São Bento 245'),
    ('Arquiteto de Soluções', 'Desenvolvimento de arquitetura para novos sistemas.', 'Tecnologia','Rua Guimaroes 2444'),
    ('Especialista em Cloud', 'Gerenciamento de serviços e infraestrutura na nuvem.', 'Tecnologia', 'Rua Armelha 585'),
    ('Administrador de Redes', 'Configuração e manutenção de redes empresariais.', 'Infraestrutura','Rua Amaru 5148455'),
    ('Redator Publicitário', 'Criação de textos para campanhas publicitárias.', 'Comunicação', 'Rua Liquid'),
    ('Desenvolvedor Backend', 'Implementação de sistemas no lado servidor.', 'Tecnologia','Rua Rebolo 9800'),
    ('Especialista em SEO', 'Otimização de sites para motores de busca.', 'Marketing','Rua Felipinos 877'),
    ('Estagiário Administrativo', 'Suporte nas atividades administrativas da empresa.', 'Administração', 'Rua Efigenia 1055'),
    ('Analista Financeiro', 'Gestão e análise de indicadores financeiros.', 'Finanças', 'Aberta','Rua de Milao 4441'),
    ('Auxiliar Contábil', 'Auxílio na organização e análise de documentos contábeis.', 'Finanças', 'Rua Bela Vista 4451'),
    ('Gestor de RH', 'Recrutamento, seleção e gestão de pessoas.', 'Recursos Humanos', 'Rua Santander'),
    ('Especialista em Segurança da Informação', 'Proteção de sistemas e dados contra ameaças.', 'Tecnologia', 'Rua Paraiso 5776'),
    ('Assistente Jurídico', 'Apoio nas atividades jurídicas e documentações.', 'Jurídico', 'Rua Alfreita 8987'),
    ('Consultor Comercial', 'Prospecção de novos clientes e negócios.', 'Comercial', 'Rua Camaro 777');
   select * from vagas 
   drop table vagas